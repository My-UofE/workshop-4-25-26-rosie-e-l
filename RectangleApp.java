...
public class RectangleApp {
	...
	public static void main( String[] args ) {
		...
		myRect1.scale(0.5);
		System.out.println("Scaling myRect1: "+myRect1.width+","+myRect2.height);
		...
		myRect2.scale(1,3);
		System.out.println("Scaling myRect2" + myRect2.width + "" + myRect2.height);
		...
		myRect3.scale(15,10);
		System.out.print("Scaling myRect3" + myRect3.width + "" + myRect3.height);
